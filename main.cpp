...
Color pink = {255, 204, 204, 255};
Color darkPink = {77, 0, 40, 255};
...
int main()
{
    ...
    InitWindow(2 * offset + cellSize * cellCount, 2 * offset + cellSize * cellCount, "Strawberry Hunt");
    SetTargetFPS(60);
    ...
    while (WindowShouldClose() == false)
    {
        ...
        DrawText("Strawberry Hunt", offset - 5, 20, 40, darkPink);
